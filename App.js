...
const imgLink = require("./assets/adaptive-icon.png");
...
// fixes the Cut Off issue
function BasicScrollSolution()
{
  return (
    <View
    style = 
...
export default BasicScrollSolution;